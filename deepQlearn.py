...
class SmartTrader:
    def __init__(self, lr, state_size, action_size, eps_decay = 0.999, batch_size=64,
        ...
        # create main model
        self.model = FFnet(lr, self.state_size, fc1_dims, fc2_dims, action_size)
    ...
    def act(self, state):
        ...
        if np.random.uniform(0, 1) < self.epsilon:
            ...
            if sum(q_out < 0) == self.action_size: # if no positive actions...
                return "DO NOTHING"
            else:
    ...
    def learn(self):
        ...
        for i in range(self.batch_size):
            ministate, miniaction, minireward = minibatch[i]
            state[i] = ministate
